...
**Status:** Implementation complete — ready PR publication pending.
...
- [ ] Publish a ready PR to `master`; leave it unmerged.
...
- [ ] Publish the ready PR and let required CI complete.
